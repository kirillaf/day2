<?xml version="1.0" encoding="utf-8"?><Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>AnotherTestClassOnDev</apexClass>
    ...
    <classAccesses>
        <apexClass>MyDevClass1</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MyDevClass2</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MyStagingClass</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Account.RandomNumber__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Account.Which_cookies_you_like__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
